...
public class KotlinLibraryDescription implements Description<KotlinLibraryDescription.Arg>, Flavored {

  private final KotlinBuckConfig kotlinBuckConfig;

  public static final ImmutableSet<Flavor> SUPPORTED_FLAVORS = ImmutableSet.of(
      KotlinLibrary.SRC_JAR,
      KotlinLibrary.MAVEN_JAR);
  ...
  public <A extends Arg> BuildRule createBuildRule(
    ...
    if (args.autodeps.orElse(false)) {
      throw new BuildTargetParseException("The autodeps build target property is not currently supported for kotlin.");
    }
